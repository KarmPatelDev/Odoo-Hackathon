      ...
      <Box position="sticky" top="0" zIndex={1}>
        <Flex
          ...
          <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
                <NavLink to="/"><Image src="https://tse4.mm.bing.net/th?id=OIP.DlopmhworTXezQBvdwoZFQHaFM&pid=Api&P=0&h=180" height={{base:"20px",md:"30px",xl:"30px"}} alt='Dan Abramov' /></NavLink>
